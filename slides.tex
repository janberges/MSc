...
\begin{document}
	...
	\begin{frame}{What about superconductivity?}
        \begin{itemize}
            \item<2-> \name{Dyson} equation
            %
            \vspace{-3mm}
    ...
    \begin{frame}{\name{Nambu} formalism}
        \begin{itemize}
            ...
            \begin{align*}
                ...
                \\
                \uncover<3->{
                    \vec G\alt<3>{^0}{^{\vphantom 0}}_{\vec k}(\I \omega_n) &=
                    \tikz [remember picture, inner xsep=0, inner ysep=1mm,
                        outer sep=0, baseline, anchor=base] \node (A) {$
                        \displaystyle -\frac{
                            \I \omega_n
                            \uncover<4->{Z_{\vec k}(\I \omega_n)}
                            \vec \sigma_0
                            \uncover<4->{+ \phi_{\vec k}(\I \omega_n)
                            \vec \sigma_1}
                            + [\epsilon_{\vec k} - \mu
                            \uncover<4->{ + \chi_{\vec k}(\I \omega_n)}]
                            \vec \sigma_3
                            }{
                            [\omega_n
                            \uncover<4->{Z_{\vec k}(\I \omega_n)}]^2
                            \uncover<4->{+ \phi^2_{\vec k}(\I \omega_n)}
                            + [\epsilon_{\vec k} - \mu
                            \uncover<4->{+ \chi_{\vec k}(\I \omega_n)}]^2
                            }
                        $};
                    }
            \end{align*}
