...
\begin{itemize}
    ...
    \item \code{differential(x, dx)}
        calculates a list of weights oder \q{differentials} \code{dx} from a
...
In this section four modules are presented which constitute the \emph{physical
...
\name{Coulomb} pseudo-potential is rescaled following Eq.~\ref{CDOS rescaled
