...
approximations are tested with respect to the critical temperature.
...
but rather the approximations proposed in Section~\ref{effective scalar coupling
strengths} tested with respect to their accuracy.
...
an involution, i.e. its own inverse. Subsequently, both asymptotes are have the
