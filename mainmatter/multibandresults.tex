...
\begin{figure}
    ...
    \input{results/connect.sl}
    \input{results/connect_back.sl}
    \input{results/connect_forth.sl}
...
\begin{figure}
    \small
    \input{results/inter_inter.sl}
    \input{results/intra_intra.sl}
    \input{results/inter_intra.sl}
    \input{results/intra_inter.sl}
    \input{results/inter_askew.sl}
    \input{results/intra_askew.sl}
...
\begin{figure}
    \small
    \input{results/lamda_inf.sl}
    \input{results/lamda_inf_hyperbola.sl}
...
\begin{figure}
    \small
    \begin{subfigure}{7cm}
        \input{results/tc_cutoff-independent.sl}
        \caption{cutoff-independent}
    \end{subfigure}%
    \begin{subfigure}{7cm}
        \input{results/tc_non-renormalized.sl}
...
error is found to be \input{results/error1.dat}\,K. Also, the statement made at
the end of Section~\ref{temperature dependence of order parameters} is
...
average absolute error is \input{results/error2.dat}\,K.
