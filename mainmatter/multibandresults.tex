...
\begin{figure}
    ...
    \input{results/order-parameters-top.sl}
    \input{results/order-parameters-left.sl}
    \input{results/order-parameters-right.sl}
...
\subsection[Hyperbolas of constant $T\sub{c}$]
    {Hyperbolas of constant \bm$T \sub c$}

\begin{figure}
    \small
    \input{results/inter-inter.sl}
    \input{results/intra-intra.sl}
    \input{results/inter-intra.sl}
    \input{results/intra-inter.sl}
    \input{results/inter-askew.sl}
    \input{results/intra-askew.sl}
...
\begin{figure}
    \small
    \input{results/asymptotes-1.sl}
    \input{results/asymptotes-2.sl}
    \caption[Asymptotes for inter-band coupling]{
        ...
        Not only exact results of the CDOS \name{Eliashberg} theory but also the
...
\begin{figure}
    \small
    \begin{subfigure}{7cm}
        \input{results/tc-1.sl}
        \caption{cutoff-independent}
    \end{subfigure}%
    \begin{subfigure}{7cm}
        \input{results/tc-2.sl}
...
error is found to be \input{results/tc-error-1.dat}\,K. Also, the statement made
...
average absolute error is \input{results/tc-error-2.dat}\,K.
