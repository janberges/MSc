...
Since \name{McMillan}'s formula has been published in 1968 \cite{McMillan68}, it
...
$\lambda$ and the \name{Coulomb} pseudo-potential $\mu^*$, which can be
...
the original paper by \name{McMillan}, to be complemented by 1\,326 citations of
a closely related publication by \name{Allen} and \name{Dynes}
\cite{AllenDynes75}.}
%
It constitutes an approximation to the more general \name{Eliashberg} theory of
...
as solutions of the multi-band \name{Eliashberg} equations and analytically
