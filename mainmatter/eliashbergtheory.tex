...
\begin{multline*}
    ...
    \frac { \I \omega_m
        ...
        - \phi _{\vec q}(\I \omega_m) \vec \sigma_1
        - \phi'_{\vec q}(\I \omega_m) \vec \sigma_2
        + [\chi_{\vec q}(\I \omega_m) + \epsilon_{\vec q}] \vec \sigma_3 }
        {\Theta_{\vec q}(\I \omega_m)}
    D^0_{\vec k - \vec q}(\I \omega_n - \I \omega_m),
\end{multline*}
%
...
\begin{align*}
    \mu = n(0) \, U,
        \quad
    \lambda_{\vec q}(\Omega_n) = -n(0) \, g^2 D_{\vec q}^0(\I \Omega_n),
        \quad
    n(E) = \frac{N(E)} N,
        \quad
    N(E) = \sum_{\vec k} \delta(E - \epsilon_{\vec k}),
\end{align*}
%
where $n(E)$ is the density of states per spin and unit cell, one can
equivalently write
%
\begin{multline*}
    \vec \Sigma_{\vec k} (\I \omega_n)
    ...
    \\
    \dots \lambda_{\vec k - \vec q}(\omega_n - \omega_m) \{ -\I
        \omega_m Z_{\vec q}(\I \omega_m) \vec \sigma_0
...
\begin{subequations}
    \begin{align}
        ...
        \sum_{\vec q m} \frac
            ...
            {\Theta_{\vec q}(\I \omega_m)}
        \lambda_{\vec k - \vec q}(\omega_n - \omega_m),
        \\
        \phi_{\vec k}(\I \omega_n) &= \frac T {N(0)}
        \sum_{\vec q m} \frac
            {\phi_{\vec q}(\I \omega_m)}
            {\Theta_{\vec q}(\I \omega_m)}
        \big[ \lambda_{\vec k - \vec q}(\omega_n - \omega_m) - \mu \big],
        \\
...
\begin{align*}
    ...
    \\
    \lambda(\Omega_n) &= \int \from{-\infty} \till \infty \D \omega \,
...
\begin{multline*}
    ...
    \\
    \dotsc \lambda(\omega_n - \omega_m) \{ - \I
        \omega_m Z(\I \omega_m) \vec \sigma_0
        +     \phi(\I \omega_m) \vec \sigma_1
        -    [\chi(\I \omega_m) + \epsilon] \vec \sigma_3 \}
...
\section{Constant-density approximation}
