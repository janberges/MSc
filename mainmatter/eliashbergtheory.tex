...
interaction, with band indices $i$ and $j$, respectively. The corresponding
local \name{Eliashberg} equations, where the band-structure only enters through
the density of states, read
%
...
\subsection{Effective coupling constant}
