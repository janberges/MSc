...
\begin{subequations} \label{Eliashberg equations}
    \begin{align}
        ...
        \sum_{\vec q m} \frac
            ...
            {\Theta_{\vec q}(\I \omega_m)}
        \big[
            \lambda_{\vec k - \vec q}(\I \omega_n - \I \omega_m) - \mu \sub C
        \big],
        \\
...
achieved, say, by taking a \name{Fermi}-surface average \cite[Eqs.~3.23,
...
\begin{multline} \label{local self-energy}
    ...
    \Theta_\epsilon^{-1}(\I \omega_m) \big \{ \dots
        ...
        - \phi(\I \omega_m) \vec \sigma_1 \mu \sub C
    \big \}
\end{multline}
%
...
\begin{subequations} \label{local Eliashberg equations}
    \begin{align}
        ...
        [\lambda(\I \omega_n - \I \omega_m) - \mu \sub C],
        \\
