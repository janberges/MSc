...
\name{Coulomb} pseudo-potential. Next, it is shown how the real-axis equations
can be obtained through analytical continuation. On this basis \name{McMillan}'s
...
Multiband \name{Eliashberg} equations with $|\omega_m| < \omega_N{}^{(*)}$:
%
\begin{equation*}
    \begin{split}
