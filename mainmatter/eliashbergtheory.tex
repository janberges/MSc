...
%
\begin{equation*}
    T \sum_m \frac 1 {\I \omega_n - \omega'} = f_+(\omega') - \frac 1 2
\end{equation*}
%
...
\begin{align*}
    ...
    = \mu \int \from{-\infty} \till \infty \D \omega' \,
    \Re \bigg[ \frac
        {\Delta(\omega'_+) \vec \sigma_1}
        {\sqrt[*]{\omega'^2_+ - \Delta^2(\omega'_+)}}
    \bigg] \bigg[ f_+(\omega') - \frac 1 2 \bigg].
\end{align*}
...
\begin{align*}
    ...
    \bigg]
    \bigg \{
        \bigg[ f_+(\omega') - \frac 1 2 \bigg] \mu
        - \int \from 0 \till \infty \D \omega'' \, \alpha^2 F(\omega'') \,
        \Omega(\omega, \omega', \omega'')
    \bigg \}.
\end{align*}
...
even-numbered quadrants or vice verse if the number is not real. As a
...
\begin{align*}
    ...
    \Big \{
        \Theta(E \sub B - \omega') \, [2 f_+(\omega') - 1] \, \mu
        + \dots
        \\
        \dots -
        &\int \from 0 \till{\omega_0} \D \omega'' \, \alpha^2 F(\omega'') \,
...
\end{equation*}
%
where $\Delta_0, \Delta_\infty \in \mathds R$. Neglecting the \name{Bose}
functions in $\Omega(\omega, \omega', \omega'')$ several approximate
...
\begin{enumerate}
    ...
    %
    \begin{align*}
        \Omega(0, \pm \omega', \omega'')
        &\approx \pm \frac{2 f_+(\omega') - 1}{\omega''}
        \\
        \Delta^{(1)}(0) &\approx -\frac 1 {Z(0)}
        \int \from 0 \till{\omega_0} \D \omega' \,
        \frac{\Delta_0}{\omega'}
        \int \from 0 \till{\omega_0} \D \omega'' \, \alpha^2 F(\omega'') \,
        \frac{4 f_+(\omega') - 2}{\omega''},
    \end{align*}
    %
    which is simplified by the definition of the \emph{electron-phonon coupling
    strength} and an approximate solution of the remaining integral:
    %
    \begin{align*}
        \Delta^{(1)}(0) &\approx \frac{\Delta_0 \lambda}{Z(0)}
        \ln \frac{\omega_0}{T \sub c},
        &
        \lambda &= 2 \int_0^{\omega_0} \frac{\D \omega''}{\omega''} \,
        \alpha^2 F(\omega''),
        &
        \int_0^{\omega_0} \frac{\D \omega'}{\omega'}
        [1 - 2 f_+(\omega')]
        &\approx \ln \frac{\omega_0}{T \sub c}.
    \end{align*}
    %
    ...
    %
    \begin{align*}
        \Omega(0, \pm \omega', \omega'') &\approx \mp \frac 1 {\omega'},
        \\
        \Delta^{(2)}(0) &\approx \frac 1 {Z(0)}
        \int \from{\omega_0} \till \infty \D \omega' \,
        \frac{\Delta_\infty}{\omega'}
        \int \from 0 \till{\omega_0} \D \omega'' \, \alpha^2 F(\omega'') \,
        \frac 2 {\omega'},
    \end{align*}
    %
    which is simplified by the definition of an \emph{average phonon frequency}
    and the exact solution of the remaining integral:
    %
    \begin{align*}
        \Delta^{(2)}(0) &\approx \frac{\Delta_0 \lambda}{Z(0)}
        \frac{\av \omega}{\omega_0},
        &
        \av \omega &= \frac 2 \lambda
        \int \from 0 \till{\omega_0} \D \omega'' \, \alpha^2 F(\omega''),
        &
    ...
    \end{align*}
    %
    \item \textbf{Electronic contribution to \bm$\Delta(0)$.} Using the above
    approximate integral,
    %
    \begin{align*}
        \Delta^{(3)}(0) &= \frac 1 {Z(0)}
        \int \from 0 \till{E \sub B} \D \omega' \,
        \frac
            { \Delta_0 \Theta(\omega_0 - \omega')
            + \Delta_\infty \Theta(\omega' - \omega_0) }
            {\omega'}
           [2 f_+(\omega') - 1] \, \mu
        \\
        &\approx -\frac \mu {Z(0)} \bigg[
    ...
    vanishes due to diverging denominators.
    %
