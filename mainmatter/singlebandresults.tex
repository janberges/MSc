...
\begin{figure}
    \small
    \input{results/pade-im.sl}
    \input{results/pade-re.sl}
...
\name{Fermi} level $\epsilon = 0$ at half-filling, at which it diverges
...
\begin{figure}
    \small
    \input{results/self-energy-delta-im.sl}
    \input{results/self-energy-delta-re.sl}
    \input{results/self-energy-chi-im.sl}
    \input{results/self-energy-chi-re.sl}
    \input{results/self-energy-z-im.sl}
    \input{results/self-energy-z-re.sl}
...
Eliashberg equations} are shown together with their \name{Padé} approximants as
...
Refs.~\barecite{Szczesniak06a} and \barecite{Szczesniak06b}.}
...
the vicinity of which the exact behavior of the \name{Padé} approximants is
...
\begin{figure}
    \small
    \centering
    \input{results/order-parameter.sl}
    \caption[\name{Eliashberg} gap]{
...
\begin{figure}
    ...
    \begin{minipage}{4.666cm}
        \input{results/cutoff-delta.sl}
    \end{minipage}%
    \begin{minipage}{4.666cm}
        \input{results/cutoff-chi.sl}
    \end{minipage}%
    \begin{minipage}{4.666cm}
        \input{results/cutoff-z.sl}
    \end{minipage}%
...
\subsection[Convergence of $T\sub{c}$ with cutoff frequency]
    {Convergence of \bm$T \sub c$ with cutoff frequency}

\begin{figure}
    \small
    \begin{subfigure}{7cm}
        \input{results/convergence-cutoff.sl}
        \caption{square lattice at quarter-filling}
    \end{subfigure}%
    \begin{subfigure}{7cm}
        \input{results/convergence-cutoff-cdos.sl}
...
\subsection[Convergence of $T\sub{c}$ with energy resolution]
    {Convergence of \bm$T \sub c$ with energy resolution}

\begin{figure}
    \small
    \centering
    \input{results/convergence-resolution.sl}
...
is deterministic) around the correct value, loosely bounded by radii which
...
\begin{figure}
    \small
    \begin{subfigure}{7cm}
        \input{results/mcmillan-1.sl}
        \caption{$\mu^* = 0$}
    \end{subfigure}%
    \begin{subfigure}{7cm}
        \input{results/mcmillan-2.sl}
        \caption{$\mu^* > 0$}
    \end{subfigure}
    \caption[\name{McMillan}'s fits]{
...
\begin{figure}
    \small
    \input{results/benchmark-lamda.sl}
    \input{results/benchmark-lamda-more.sl}
    \input{results/benchmark-omegae.sl}
    \input{results/benchmark-mustar.sl}
...
\name{Green} function, the \q{broadening} of which is determined by $T / \omega
\sub E$.
...
\begin{figure}
    \small
    \centering
    \input{results/energy-dos.sl}
    \input{results/energy-shift.sl}
    \input{results/energy-tc.sl}
...
electron-phonon and \name{Coulomb} interaction must vanish in order to justify
