...
\begin{figure}
    \input{results/imaginary-axis.sl}
    \input{results/real-axis.sl}
...
\begin{figure}
    ...
    \end{subfigure}%
    \begin{subfigure}[b]{4.666cm}
        \input{results/square_lattice_dispersion.sl}
        \caption{dispersion}
        \label{square-lattice dispersion}
    \end{subfigure}%
    \begin{subfigure}[b]{4.666cm}
        \input{results/square_lattice_dos.sl}
...
\begin{figure}
    \small
    \input{results/Delta(iomega).sl}
    \input{results/Delta(omega).sl}
    \input{results/chi(iomega).sl}
    \input{results/chi(omega).sl}
    \input{results/Z(iomega).sl}
    \input{results/Z(omega).sl}
...
\begin{figure}
    \small
    \centering
    \input{results/order_parameter.sl}
    \caption[\name{Eliashberg} gap]{
...
\begin{figure}
    ...
    \begin{minipage}{4.666cm}
        \input{results/Delta_N(iomega).sl}
    \end{minipage}%
    \begin{minipage}{4.666cm}
        \input{results/chi_N(iomega).sl}
    \end{minipage}%
    \begin{minipage}{4.666cm}
        \input{results/Z_N(iomega).sl}
    \end{minipage}%
...
\begin{figure}
    \small
    \begin{subfigure}{7cm}
        \input{results/cutoff_frequency.sl}
        \caption{square lattice at quarter-filling}
    \end{subfigure}%
    \begin{subfigure}{7cm}
        \input{results/cutoff_frequency_cdos.sl}
...
\begin{figure}
    \small
    \centering
    \input{results/integration_points.sl}
...
\begin{figure}
    \small
    \begin{subfigure}{7cm}
        \input{results/mcmillan_1st.sl}
        \caption{$\mu^* = 0$}
    \end{subfigure}%
    \begin{subfigure}{7cm}
        \input{results/mcmillan_2nd.sl}
        \caption{$\mu^* > 0$}
    \end{subfigure}
    \caption[\name{McMillan}'s fits]{
...
\begin{figure}
    \small
    \input{results/tc_lamda.sl}
    \input{results/tc_lamda_2.sl}
    \input{results/tc_omegaE.sl}
    \input{results/tc_muStar.sl}
...
\begin{figure}
    \small
    \centering
    \input{results/energy_dos.sl}
    \input{results/energy_shift.sl}
    \input{results/energy_tc.sl}
