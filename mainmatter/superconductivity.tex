...
In 1933 the misconception of superconductors which obey \name{Ohm}'s law is
...
observation the \name{London} brothers formulated a first macroscopic theory
...
of \name{Ginzburg} and \name{Landau} from about 1950, which introduces an order
...
superconductivity. In 1952, his electron-phonon \name{Hamilton} operator is
...
superconductivity was formulated by \name{Bardeen}, \name{Cooper} and
...
1960, \name{Eliashberg} established a theory which accounts for this retarded
...
total momentum of a \name{Cooper} pairs remains zero, the intern momentum
...
\name{Fermi} level, the interaction strength is given by
%
\begin{equation*}
...
\name{Cooper} pair operators and a constant energy shift, respectively, are
...
are given by \name{Fermi} functions $f(E_{\vec k})$ as will be derived in
