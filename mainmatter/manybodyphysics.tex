...
Calculate 1st/2nd order of perturbation series explicitly.

\subsection{\name{Holstein} model}

Further application of \textsc{Wick}'s theorem to the electronic part
$\av{\text{el.}}_0$ yields
%
\begingroup
	\def\minalignsep{0pt}
...
Substituting the corresponding non-interacting \textsc{Green} functions one
obtains
%
\begin{align*}
