...
textbooks such as the one by \name{Mahan} \cite{Mahan00} on the present
subject.}
...
\name{Wick} theorem for non-zero temperatures are derived, which prepare the
ground for \name{Feynman}'s diagrammatical perturbation theory. For some model
...
of their formal argument. This concerns mutual \name{Fourier} transforms as well
...
%
\footnote{\name{Dirac} introduced such operator in §\,44 \qq{The perturbation
...
both momentum and spin. For this type of interaction, a general diagram contains
%
\begin{equation*}
    ...
    \begin{tikzpicture}[baseline=-0.5ex]
        \begin{scope}[gray]
            \draw [electron] (0, 0) +(225:5mm) -- (0, 0);
            \draw [phonon] (0, 0) -- +(90:5mm);
            \draw [electron] (0, 0) -- +(-45:5mm);
        \end{scope}
