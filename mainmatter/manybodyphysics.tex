...
Finally, the \name{Matsubara-Green} function on the imaginary-axis as defined in
...
%
\begin{equation} \label{auxiliary Green functions}
    \begin{split}
...
For completeness, the corresponding results $\widetilde G_{\vec k \sigma}(\I
\omega_n)$ and $\widetilde F_{\vec k \sigma}(\I \omega_n)$ shall be derived as
well. From Eqs.~\ref{G_0(i omega_n)} and \ref{D_0(i omega_n)} it follows that
$G^0_{\vec k \sigma}(\I \omega_n) = [G^0_{\vec k \sigma}(-\I \omega_n)]^*$ and
$D^0_{\vec q}(\I \omega_n) = [D^0_{\vec q}(-\I \omega_n)]^* = D^0_{-\vec q}(-\I
\omega_n)$. Using Eq.~\ref{auxiliary Green functions},
%
\begin{align*}
    \widetilde G \super{2nd}_{\vec k \sigma}(\I \omega_n)
    = -G \super{2nd}_{-\vec k -\sigma}(-\I \omega_n)
    = \widetilde G^0_{\vec k \sigma}(\I \omega_n) \,
    \Sigma_{\vec k \sigma}^{\widetilde G}(\I \omega_n) \,
    \widetilde G^0_{\vec k \sigma}(\I \omega_n),
    \\
    \widetilde F \super{2nd}_{\vec k \sigma}(\I \omega_n)
    = [F \super{2nd}_{\vec k \sigma}(-\I \omega_n)]^*
    = \widetilde G^0_{\vec k \sigma}(\I \omega_n) \,
    \Sigma_{\vec k \sigma}^{\widetilde F}(\I \omega_n) \,
    G^0_{\vec k \sigma}(\I \omega_n).
\end{align*}
